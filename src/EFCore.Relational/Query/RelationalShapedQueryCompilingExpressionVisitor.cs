...
public partial class RelationalShapedQueryCompilingExpressionVisitor : ShapedQueryCompilingExpressionVisitor
{
    ...
    {
        private readonly MethodInfo _myMagicMethodInfo = typeof(JsonMappedEntityCompilingExpressionVisitor).GetMethod(nameof(MyMagicMethod))!;
        ...
        //private readonly MethodInfo _extractJsonPropertyMethodInfo2 = typeof(JsonMappedEntityCompilingExpressionVisitor).GetMethod(nameof(ExtractJsonProperty2))!;
