...
public class RelationalQueryableMethodTranslatingExpressionVisitor : QueryableMethodTranslatingExpressionVisitor
{
    ...
    protected override ShapedQueryExpression? TranslateAverage(
        ...
        Type resultType)
        => TranslateAggregateWithSelector(source, selector, t => QueryableMethods.GetAverageWithoutSelector(t), throwWhenEmpty: true, resultType);
    ...
    protected override ShapedQueryExpression? TranslateSum(ShapedQueryExpression source, LambdaExpression? selector, Type resultType)
        => TranslateAggregateWithSelector(source, selector, t => QueryableMethods.GetSumWithoutSelector(t), throwWhenEmpty: false, resultType);
